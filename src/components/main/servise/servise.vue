        ...
        <div v-if="item.isFolder"
          ...
          <div class="mt-2 ml-10">
            <div v-for="(file, fileIndex) in folderContents[item.id]" :key="file.id"
              class="flex items-center justify-between my-1 min-h-[50px] p-[45px] text-lg bg-white border border-blue-500 rounded-[10px] shadow-md cursor-pointer hover:bg-lime-500 duration-300"
