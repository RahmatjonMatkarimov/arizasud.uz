  ...
  <div class="dark:bg-gray-800 min-h-screen">
    ...
    >
      ...
      >
        ...
        <div class="text-center mb-8">
          ...
          <h2 class="text-2xl font-bold text-white mb-2">Court yuklash</h2>
          <p class="text-white/60 text-sm">
            Court ma'lumotlarini kiriting va rasmni yuklang
          </p>
        </div>
        ...
        <form @submit.prevent="uploadCourt" ref="form" class="space-y-6">
          <!-- Court Name Input -->
          <div class="space-y-2">
            <label class="block text-white/80 text-sm font-medium">Court nomi</label>
            <div class="relative">
              <input
                v-model="courtName1"
                ...
                type="text"
                id="name"
                placeholder="Court nomini kiriting..."
                required
              />
          ...
          <!-- File Upload -->
          <div class="space-y-2">
            <label class="block text-white/80 text-sm font-medium">Court rasmi</label>
            <div
            ...
            >
              ...
              <div class="space-y-2">
                ...
                <div>
                  <p class="text-white/70 font-medium">Rasmni yuklash uchun bosing</p>
                  <p class="text-white/50 text-xs mt-1">PNG, JPG, JPEG (max. 10MB)</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="relative z-10">
          ...
          <div class="text-center mb-8">
            ...
            <p class="text-slate-400 text-sm">
              Court faylini yuklash uchun ma'lumotlarni kiriting
            </p>
          </div>
            ...
            <div class="space-y-2">
              ...
              <div class="relative group">
                <input
                  ...
                  type="text"
                  :placeholder="
                    dat === 'datakril' ? translateText('Court Name') : 'Court Name'
                  "
                  required
                />
                  ...
                  <div class="space-y-3">
                    ...
                    <div>
                      ...
                      <p class="text-slate-500 text-xs mt-1">
                        Barcha fayl turlari qo'llab-quvvatlanadi
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div class="mt-6 space-y-3">
            <div
              v-if="successMessage"
              class="p-4 bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 rounded-xl backdrop-blur-sm"
            >
            ...
            <div
              v-if="errorMessage"
              class="p-4 bg-gradient-to-r from-red-500/20 to-rose-500/20 border border-red-500/30 rounded-xl backdrop-blur-sm"
            >
              <div class="flex items-center space-x-3">
                <div class="flex-shrink-0">
                  <svg
        ...
        <div class="relative z-10">
          ...
          <div class="text-center mb-8">
            ...
            <p class="text-slate-400 text-sm max-w-sm mx-auto leading-relaxed">
              Court ma'lumotlarini va rasmini yangilash uchun quyidagi maydonlarni
              to'ldiring
            </p>
          </div>
                  ...
                  <div class="space-y-4 relative z-5">
                    ...
                    <div>
                      ...
                      <p class="text-slate-500 text-xs mt-2">
                        PNG, JPG, JPEG formatlarida (max. 10MB)
                      </p>
                    </div>
                  </div>
                </div>
            ...
            >
              <span class="relative z-10 flex items-center justify-center space-x-3">
                ...
                <span class="tracking-wide">{{
                  dat === "datakril" ? translateText("yuklash") : "YANGILASH"
                }}</span>
              </span>
          ...
          <div class="mt-8 space-y-4">
            <div
              v-if="successMessage"
              class="relative p-5 bg-gradient-to-r from-green-500/25 to-emerald-500/25 border border-green-500/40 rounded-2xl backdrop-blur-sm overflow-hidden"
            >
              <div
                class="absolute inset-0 bg-gradient-to-r from-green-400/10 to-emerald-400/10"
              ></div>
              <div class="relative flex items-center space-x-4">
                <div class="flex-shrink-0">
                  <div
                    class="w-10 h-10 bg-green-500/30 rounded-full flex items-center justify-center"
                  >
                    <svg
                ...
                <p class="text-green-200 font-semibold">{{ successMessage }}</p>
              </div>
            </div>

            <div
              v-if="errorMessage"
              class="relative p-5 bg-gradient-to-r from-red-500/25 to-rose-500/25 border border-red-500/40 rounded-2xl backdrop-blur-sm overflow-hidden"
            >
              <div
                class="absolute inset-0 bg-gradient-to-r from-red-400/10 to-rose-400/10"
              ></div>
              <div class="relative flex items-center space-x-4">
                <div class="flex-shrink-0">
                  <div
                    class="w-10 h-10 bg-red-500/30 rounded-full flex items-center justify-center"
                  >
                    <svg
                ...
                <p class="text-red-200 font-semibold">{{ errorMessage }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        ...
        <div class="relative z-10">
          ...
          <div class="text-center mb-8">
            ...
            <p class="text-slate-400 text-sm">Ma'lumotlarni o'zgartiring va saqlang</p>
          </div>
          ...
          <form @submit.prevent="updateCourt" class="space-y-6">
            <!-- Court Name Input -->
            <div class="space-y-2">
              <label class="block text-slate-300 text-sm font-medium">Court nomi</label>
              <div class="relative group">
                <input
                  v-model="courtName"
            ...
            <!-- File Upload -->
            <div class="space-y-2">
              <label class="block text-slate-300 text-sm font-medium">Yangi rasm</label>
              <div class="relative">
                <div
          ...
          <div class="mt-6 space-y-3">
            <div
              v-if="successMessage"
              class="relative p-4 bg-gradient-to-r from-emerald-500/20 to-green-500/20 border border-emerald-500/30 rounded-xl backdrop-blur-sm overflow-hidden"
            >
              <div
              ...
              <div class="relative flex items-center space-x-3">
                <div class="flex-shrink-0">
                  <div
                    class="w-8 h-8 bg-emerald-500/30 rounded-full flex items-center justify-center"
                  >
                    <svg
                ...
                <p class="text-emerald-200 font-medium text-sm">{{ successMessage }}</p>
              </div>
            </div>

            <div
              v-if="errorMessage"
              class="relative p-4 bg-gradient-to-r from-red-500/20 to-rose-500/20 border border-red-500/30 rounded-xl backdrop-blur-sm overflow-hidden"
            >
              <div
                class="absolute inset-0 bg-gradient-to-r from-red-400/5 to-rose-400/5"
              ></div>
              <div class="relative flex items-center space-x-3">
                <div class="flex-shrink-0">
                  <div
                    class="w-8 h-8 bg-red-500/30 rounded-full flex items-center justify-center"
                  >
                    <svg
                ...
                <p class="text-red-200 font-medium text-sm">{{ errorMessage }}</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div v-if="asd" @click="asd = false" class="fixed inset-0 z-40">
      ...
      >
        ...
        <div class="p-8 pt-12">
          ...
          <div class="space-y-4 mb-6">
            ...
            >
              ...
              >
                ...
                {{ dat === "datakril" ? translateText("remove") : "remove" }}
              </div>
            </button>
          </div>
          ...
          <!-- Status toggle card -->
          <div
            class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 dark:from-gray-800 dark:via-gray-700 dark:to-gray-800 border border-gray-200/50 dark:border-gray-600/50 p-6 shadow-lg hover:shadow-xl transition-all duration-500 hover:scale-[1.01] group"
          >
            <!-- Decorative elements -->
            <div
    ...
    <div class="flex flex-col items-center py-10">
      ...
      >
        ...
        >
          {{ dat === "datakril" ? translateText("create") : "create" }}
        </button>
        <button
          v-if="data.length"
          @click="toggleModal"
          class="text-lg font-medium py-2 px-4 bg-lime-500 hover:bg-lime-600 rounded-lg"
        >
          {{ dat === "datakril" ? translateText("bolim_yaratish") : "bolim_yaratish" }}
        </button>
      </div>
      ...
      >
        <div
          class="rounded-[20px] max-w-[110rem] p-10 mb-16 opacity-[98%] w-[1200px] shadow-2xl bg-gray-300"
        >
          <div
            v-if="dat === 'datalotin'"
          ...
          >
            ...
            <img
              ...
              alt="Word Icon"
            />
            <h1 class="text-black flex-1" @click="goToCard(item.id)">
              {{ item.fileName }}
            </h1>
            <div class="flex relative z-40 gap-2">
              <img
                @click.stop="Modalfile(item.id)"
                class="w-4 h-4 cursor-pointer"
                src="../../../../public/pen.png"
                alt="Edit"
              />
              <img
                @click.stop="removefileItems(item.id)"
                class="w-4 h-4 cursor-pointer"
      ...
      <div class="w-full max-w-6xl mt-6">
        <div class="carousel flex" :style="{ '--total-items': courts.length }">
          <div
            v-for="item in courts"
            :key="item.id"
            @click="reload(item.id)"
            class="carousel-item flex-none flex flex-col items-center dark:bg-gray-700 bg-white border-4 border-blue-800 rounded-lg p-4 w-64 dark:border-2"
          >
            <img
              :src="`${URL}/upload${item.img}`"
              alt="Court Image"
              class="w-[60px] h-[60px] object-cover rounded-md mb-2"
            />
            <h3 class="text-lg font-medium text-center text-black dark:text-gray-200">
        ...
        <div class="w-full rounded-lg p-6 sm:p-10">
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div
              ...
              class="relative dark:bg-gray-700 bg-white border-4 border-blue-800 rounded-lg p-6"
            >
              <img
                @click.stop="func(item.id, $event)"
                class="absolute z-40 top-2 right-2 w-6 h-6 cursor-pointer"
                src="/ellipsis.png"
                alt="Options"
              />
              <div class="flex items-center gap-4">
                ...
                />
                <h3 class="text-lg font-medium text-center dark:text-gray-200 text-black">
                  {{ item.name }}
                </h3>
              </div>
              <div
                v-if="item.workStatus"
                class="bg-blue-400/50 flex justify-center items-end animate-pulse rounded-[5px] inset-0 w-full absolute h-full"
              >
                <b class="text-black dark:text-gray-200 font-bold text-[20px]">{{
                  dat === "datakril" ? translateText("tez_kunda") : "tez_kunda"
                }}</b>
              </div>
            </div>
            <div
            ...
            >
              ...
              <div
                v-if="item.workStatus"
                class="bg-blue420/500 flex justify-center items-end animate-pulse rounded-[5px] inset-0 w-full absolute h-full"
              >
                <b class="text-black dark:text-gray-200 font-bold text-[20px]">{{
                  dat === "datakril" ? translateText("tez_kunda") : "tez_kunda"
                }}</b>
...
const dat = "datalotin"; // or 'datakril' based on your data
...
const updatefileCourt = async () => {
  ...
  try {
    ...
    errorMessage.value =
      dat === "datakril" ? translateText("Yangilashda xatolik!") : "Yangilashda xatolik!";
  }
};
...
const removeSelectedItems = async () => {
  ...
  try {
    ...
    errorMessage.value =
      dat === "datakril" ? translateText("O'chirishda xatolik!") : "O'chirishda xatolik!";
  }
};
...
.carousel-item {
  flex: 0 0 256px; /* Fixed width of 64rem (256px) */
...
@keyframes scroll {
  ...
  100% {
    transform: translateX(
      calc(-256px * var(--total-items) - 1.5rem * var(--total-items))
    );
  }
}@keyframes scroll {
...
@media (max-width: 640px) {
  .carousel-item {
    flex: 0 0 180px; /* Smaller width for mobile */
    margin-right: 1rem;
  }
  @keyframes scroll {
    0% {
    ...
    100% {
      transform: translateX(
        calc(-180px * var(--total-items) - 1rem * var(--total-items))
      );
    }
  }
}
