...
const cards = ref([
  ...
  {
    title: "Coll-center Bo'limi",
    description: "Coll-centerlarni boshqarish",
    icon: "mdi:headset",           // coll-center uchun mos icon
    bgColor1: "#06B6D4",           // ko‘k-yashil (cyan) rang – xizmatga mos
    bgColor: "#06B6D420",          // och versiyasi
    routerLink: "/operator",
