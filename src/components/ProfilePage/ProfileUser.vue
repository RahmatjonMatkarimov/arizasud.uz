  ...
  <div class="max-w-4xl mx-auto p-6">
    ...
    <div v-else-if="userInfo" class="bg-blue-800 rounded-lg shadow-md p-6">
      ...
      <div class="space-y-3">
        ...
        <button @click="router.push(`/requireUserTasksFiles`)" class="border hover:bg-lime-500 duration-500 hover:text-black text-[20px] w-full py-2 rounded-md">
          Hodim Vazifalari
        </button>
        <button @click="router.push(`/requireUserobligationsFiles`)" class="border hover:bg-lime-500 duration-500 hover:text-black text-[20px] w-full py-2 rounded-md">
          Hodim Majburiyatlari
        </button>
        <button @click="router.push(`/requireUserInfoFiles`)" class="border hover:bg-lime-500 duration-500 hover:text-black text-[20px] w-full py-2 rounded-md">
          Hodim Ma'lumotlari
        </button>
      </div>
    </div>
