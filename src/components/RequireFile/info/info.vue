<template>
  <div
    class="min-h-screen bg-white text-gray-900 font-sans antialiased dark:bg-gradient-to-br dark:from-gray-950 pt-8 dark:via-indigo-900 dark:to-teal-950 dark:text-gray-50"
  >
    <!-- Main Content -->
    <div
      class="max-w-[95%] mx-auto p-8 bg-white/90 dark:bg-gray-900/80 backdrop-blur-md rounded-3xl shadow-2xl border border-gray-200/30 dark:border-gray-800/30"
    >
      <!-- Create Button -->
      <div class="flex justify-end">
        ...
        >
          ...
          <div
            class="absolute inset-0 bg-blue-600 dark:bg-gradient-to-r dark:from-emerald-600 dark:to-cyan-600 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
          ></div>
        </button>
      </div>
          ...
          <div class="flex-1 min-w-0">
            <h1 class="text-lg font-semibold text-gray-900 dark:text-gray-50 truncate">
              ...
              <span class="text-sm text-gray-500 dark:text-gray-400">{{
                translateText(file.User.lavozimi)
              }}</span>
            </h1>
            <p
              @click="openFile(file)"
    ...
    >
      ...
      >
        ...
        >
          <h3 class="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-6">
            Yangi fayl yuklash
          </h3>
          <input
            type="text"
    ...
    >
      ...
      >
        ...
        >
          <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-50 mb-4">
            {{ $t("korib_chiqish") }}
          </h1>
          <input
            v-model="massage"
...
const getdata = async () => {
  ...
  try {
    ...
    const response = await axios.get(
      `${URL}/${localStorage.getItem("role")}/${managerID.value}`
    );
...
const fetchFiles = async () => {
  ...
  try {
    ...
    files.value = response.data.userFiles
