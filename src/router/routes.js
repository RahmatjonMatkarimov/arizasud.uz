export const routes = [
    ...
    { path: '/finger', component: () => import('@/components/finger.vue'), props: { errorCode: 404 } },
    {
      ...
      children: [
        ...
        { path: '/video-open/:id', component: () => import('@/components/contract/vidoeOpen.vue') },
      ...
      meta: { requiresAuth: true, allowedRoles: ['admin', 'manager','yuristAssistant','deliverer', 'yurist', 'bigAdmin'] },
    },
  ];